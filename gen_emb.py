...
from cogdl.models.nn.dgi import DGIModel
from cogdl.datasets import GraphDataset

# flags
FLAGS = flags.FLAGS
flags.DEFINE_integer('cg_emb_dim', 80, 'Cascade graph embedding dimension.')
...
def get_global_index_and_embedding(gg, method):
    ...
    print(f'Generating embeddings of nodes in global graph by {method}')
...
def main(argv):
    ...
    gg_emb, id2row = get_global_index_and_embedding(gg, FLAGS.gg_method)
