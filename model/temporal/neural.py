...
class NeuralPointProcess(TemporalPointProcess):
    ...
    def logprob(self, event_times, spatial_locations, input_mask, t0, t1):
        intensities, Lambda, pre_hiddens, final_state = self.integrate_lambda(event_times, spatial_locations, input_mask, t0, t1, self.solver)
        ...
        # print("event:",torch.sum(log_intensities, dim=1).mean(),"no-event:",Lambda.mean())
        logprob = torch.sum(log_intensities, dim=1) - Lambda
        return final_state, Lambda, logprob, pre_hiddens
